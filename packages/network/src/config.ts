...
export const defaultMaxConnections = 50;
export const defaultTcpPort = 4191;
export const defaultUdpPort = 9810;
export const defaultNat = '127.0.0.1';

export const seedCount = 30;
export const seedMaxAge = 5 * 24 * 60 * 60 * 1000;
